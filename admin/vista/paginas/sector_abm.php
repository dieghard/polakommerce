       ...
       <div class="row">
        <div class="box box-solid box-success">
                <div class="box-header">  
                    <h4>Maestro Sectores <button type="button" class="btn btn-primary" id="btnNuevo" title="haga un click aqui para ingresar un nuevo sector">NUEVO SECTOR</button> </h4>
                </div>
                <div class="box-body">            
                     <div id="tabla">
                         <!---se llena por j -->
...
<!-- /////////////////////////////////////////////////////////////////////-->
<script src="paginas/js/sector.js"></script>
